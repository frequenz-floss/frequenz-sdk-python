...
class TestBatteryPoolControl:
    ...
    async def test_case_5(  # pylint: disable=too-many-statements,too-many-locals
        ...
        battery_pool_4 = microgrid.new_battery_pool(priority=4, in_shifting_group=True)
        bounds_4_rx = battery_pool_4.power_status.new_receiver()
        battery_pool_3 = microgrid.new_battery_pool(priority=3, in_shifting_group=True)
